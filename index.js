...
App.__name__ = true;
App.__init = function(attributes,inst) {
	if(inst == null) {
		inst = new App(attributes);
	} else {
...
Main.main = function() {
	...
	var __r = [];
	var __ret = { };
	__r.push(coconut_ui_tools_ViewCache.mk("App",null,App.__init,__ret));
...
vdom__$VNode_VNode_$Impl_$.autoRender = function(this1) {
	return vdom__$VNode_VNode_$Impl_$.toElement(this1);
};
vdom__$VNode_VNode_$Impl_$.toElement = function(this1) {
	if(typeof this1.toElement === "function") {
		return this1.toElement();
	} else {
